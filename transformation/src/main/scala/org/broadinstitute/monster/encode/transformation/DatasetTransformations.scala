...
object DatasetTransformations {
  ...
  def transformDataset(): Dataset = {
    ...
    Dataset(
      ...
      owner = List("https://www.encodeproject.org/help/project-overview/"),
      fundedBy = "http://www.genome.gov/10005107" :: List(),
      generatedBy = "https://www.encodeproject.org/help/project-overview/" :: List(),
      dataUsePermission = List("http://purl.obolibrary.org/obo/DUO_0000004"),
      consentGroup = List(),
      principalInvestigator = List(),
      registeredIdentifier = List(),
